...
public class WizardTestContainer extends TestContainer {

    public WizardTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/wizard/app.properties",
    ...
    public static class Common extends WizardTestContainer {

        public static final WizardTestContainer.Common INSTANCE = new WizardTestContainer.Common();
